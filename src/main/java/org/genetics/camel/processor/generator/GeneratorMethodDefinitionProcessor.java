...
public class GeneratorMethodDefinitionProcessor implements Processor, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        randomWeight.addByWeight(100, Constants.GENERATOR_METHOD_ENRICH_EXISTING);
        randomWeight.addByWeight(200, Constants.GENERATOR_METHOD_MIX_EXISTING);

        randomWeight.addByPeriod(10 * MINUTE, Constants.GENERATOR_METHOD_RANDOM);
